...
export function ToLocation() {
  ...
  const [address, setAddress] = useState(formData.addresses?.destination?.address || '');
    ...
    <div className="animate-in fade-in-0 slide-in-from-right-4 duration-300">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground leading-relaxed">
          Enter your destination address to complete the route planning
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <div className="relative group">
            <Navigation className="input-icon group-focus-within:text-success" />
            <input
              type="text"
              value={address}
              ...
              className={`
                ...
                ${errors.destinationAddress
                  ...
                  : 'border-border hover:border-border/80 focus:border-success focus:ring-4 focus:ring-success/10'
                }
          ...
          {errors.destinationAddress && (
            <div className="flex items-center gap-2 mt-2">
              ...
              <p className="text-sm text-destructive font-medium">{errors.destinationAddress}</p>
            </div>
          )}
        </div>
        ...
        <div className="border-t border-border/20 pt-6 mt-6">
          <button
            ...
            className="
              w-full py-3 px-4 bg-success text-success-foreground rounded-lg 
      ...
      <div className="mt-8 pt-6 border-t border-border/30">
        <div className="flex items-center justify-center gap-2 text-muted-foreground">
          ...
          <p className="text-sm">
            Final step for route calculation and logistics planning
          </p>
          <div className="w-1 h-1 bg-muted-foreground/40 rounded-full" />
        </div>
      </div>
